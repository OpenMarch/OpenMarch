...
OpenMarch respects your privacy. To learn more about how we handle personal data, please see our [Privacy Policy](/privacy).
...
3.  OpenMarch Data. OpenMarch will collect data about how its customers use the Services, including but not limited to aggregated and anonymized data based on Your Content and the content of other users (collectively, “**OpenMarch Data**”). OpenMarch owns all right, title, and interest in and to the OpenMarch Data.
...
If you have any questions about the Services, please do not hesitate to contact us at [support@openmarch.com](mailto:support@openmarch.com) or at the following address:
