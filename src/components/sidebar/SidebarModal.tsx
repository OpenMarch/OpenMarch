...
export default function SidebarModal() {
    ...
    return (
        <div
            ...
            onFocus={handleFocus}
            onBlur={handleBlur}
            className={`absolute left-0 top-0 z-40 h-full min-h-0 max-w-[35rem] overflow-scroll rounded-6 border border-stroke bg-modal p-12 shadow-fg-1 outline-none backdrop-blur-32 ${
