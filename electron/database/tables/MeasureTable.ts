...
export function createMeasures({
    ...
    console.log("\n=========== start createMeasures ===========");
    const newMeasuresResponse = DbActions.createItems<
        DatabaseMeasure,
        NewMeasureArgs
    >({
        db,
    ...
    console.log("=========== end createMeasures ===========\n");
    return newMeasuresResponse;
}
...
export function updateMeasures({
    ...
    console.log("\n=========== start updateMeasures ===========");
    const output = DbActions.updateItems<DatabaseMeasure, ModifiedMeasureArgs>({
        db,
        tableName: Constants.MeasureTableName,
        items: modifiedMeasures,
        useNextUndoGroup: true,
    });
    console.log("=========== end updateMeasures ===========\n");
    return output;
}
...
export function deleteMeasures({
    ...
    console.log("=========== begin deleteMeasures ===========");
    const output = DbActions.deleteItems<DatabaseMeasure>({
        db,
        tableName: Constants.MeasureTableName,
        ids: measureIds,
        printHeaders: false,
    });
    console.log("=========== end deleteMeasures ===========\n");
