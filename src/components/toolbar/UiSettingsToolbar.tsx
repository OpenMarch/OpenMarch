...
export default function UiSettingsToolbar({ className }: Interfaces.topBarComponentProps) {
    ...
    return (
        <div className={`${className}`} title="Ui Settings Toolbar" aria-label="Ui Settings Toolbar">
            <RegisteredActionButton
                registeredAction={RegisteredActionsObjects.togglePreviousPagePaths}
                instructionalString={uiSettings.previousPaths ?
            ...
            <RegisteredActionButton
                ...
                instructionalString={uiSettings.nextPaths ?
