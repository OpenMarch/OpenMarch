...
import AlignmentTab from "@/components/toolbar/tabs/AlignmentTab";
...
import SelectTab from "@/components/toolbar/tabs/SelectTab";

/**
 * Drill editor toolbar tabs (file, alignment, select, view, collisions).
 */
                    ...
                    {!isFullscreen && (
                        <>
                            ...
                            <TabItem value="select">
                                <T keyName="inspector.shape.selectTab" />
                            </TabItem>
                        </>
                    )}
                    <TabItem value="view">
