...
//  */
// export async function  updatePages(modifiedPagesArg: ModifiedPageArgs[]) {
...
//  */
// export async function  deletePages(pageIds: Set<number>) {
...
//  */
// export function checkForFetchPages() {
//     if (!this.fetchPages)
//         console.error(
