...
describe("FieldProperties", () => {
    ...
    describe("NCAA", () => {
        ...
        beforeEach(() => {
            NCAAFieldProperties = new FieldProperties(
        ...
        it("should create a valid FieldProperties object for NCAA template", () => {
            ...
            expect(NCAAFieldProperties.centerFrontPoint).toEqual({
                xPixels: 800,
                yPixels: 853.3,
            });
        ...
        it("should create the y checkpoints for an NCAA football field", () => {
            ...
            const testFrontHash = yCheckpoints.find(
                (checkpoint) => checkpoint.name === "front hash"
            );
            ...
            const testGridBackHash = yCheckpoints.find(
                (checkpoint) => checkpoint.name === "grid back hash"
            );
            ...
            const testRealBackHash = yCheckpoints.find(
                (checkpoint) => checkpoint.name === "real back hash"
            );
        ...
        it("should get the yard number coordinates for an NCAA football field", () => {
            const yardNumberCoordinates =
                FieldProperties.getYardNumberCoordinates(
                    FieldProperties.Template.NCAA
                );
            expect(yardNumberCoordinates).toEqual({
    ...
    describe("High School", () => {
        ...
        beforeEach(() => {
            HighSchoolFieldProperties = new FieldProperties(
                FieldProperties.Template.HIGH_SCHOOL
            );
        });
        ...
        it("should create the y checkpoints for an high school football field", () => {
            ...
            const testBackHash = yCheckpoints.find(
                (checkpoint) => checkpoint.name === "back hash"
            );
