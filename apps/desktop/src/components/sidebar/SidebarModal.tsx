...
export default function SidebarModal() {
    ...
    return (
        <div
            ...
            onFocus={handleFocus}
            onBlur={handleBlur}
            className={`rounded-6 border-stroke bg-modal shadow-fg-1 backdrop-blur-32 absolute top-0 left-[50px] z-40 h-full min-h-0 max-w-[36rem] overflow-scroll border p-12 outline-hidden ${
