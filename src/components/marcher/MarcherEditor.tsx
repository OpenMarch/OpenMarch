                    ...
                    <div className="ml-2">
                        ...
                        {!rCoords ? <p>Error loading coordinates</p> :
                            <form className="coords-editor edit-group" ref={coordsFormRef} onSubmit={handleCoordsSubmit}>
                                ...
                                <div className="input-group">
                                    ...
                                    <input className="bg-transparent text-inherit w-12 border-none" disabled={true} type="number" defaultValue={rCoords?.xSteps} ref={xInputRef} />
                                    <select
                                    ...
                                    <select className="bg-transparent text-inherit border-none" disabled={true} ref={xCheckpointRef} defaultValue={rCoords.xCheckpoint.terseName || rCoords.xCheckpoint.name}>
                                    ...
                                    <select disabled={true} className="bg-transparent text-inherit border-none" ref={fieldSideRef} defaultValue={rCoords.side}>
                                ...
                                <div className="input-group">
                                    <input className="bg-transparent text-inherit border-none w-12" disabled={true} type="number" value={rCoords?.ySteps} ref={yInputRef} />
                                    <select
                                        className="bg-transparent text-inherit border-none"
                                        disabled={true}
                                    ...
                                    <select className="bg-transparent text-inherit border-none" disabled={true} ref={yCheckpointRef} defaultValue={rCoords.yCheckpoint.terseName || rCoords.yCheckpoint.name}>
                        ...
                        <form className="marcher-details-editor edit-group" ref={detailsFormRef}>
                            <div className="input-group">
                                ...
                                <input className="bg-transparent text-inherit border-none text-right" type="text"
                            ...
                            <div className="input-group">
                                ...
                                <input className="bg-transparent text-inherit border-none text-right" type="text" value={selectedMarchers[0].section} disabled={true} id="section-input" />
                            </div>
                            <div className="input-group">
                                <label htmlFor="drill-number-input">Drill Number</label>
                                <input className="bg-transparent text-inherit border-none text-right" type="text" value={selectedMarchers[0].drill_number} disabled={true} id="drill-number-input" />
                            </div>
                            {/* This is here so the form submits when enter is pressed */}
                            <button type="submit" style={{ display: 'none' }}>
                                Submit
