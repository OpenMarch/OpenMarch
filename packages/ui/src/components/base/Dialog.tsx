...
export const DialogContent = ({
    ...
    return (
        <RadixDialog.Portal>
            <RadixDialog.Overlay
                className={twMerge(
                    "bg-modal-overlay data-[state=open]:animate-fade-in fixed inset-0 z-[1000]",
                    overlayClassName,
                )}
            />
            <div className="data-[state=open]:animate-fade-in fixed inset-0 z-[1001] flex items-center justify-center">
                <RadixDialog.Content
                    {...props}
                    className={clsx(
