...
//     if (!(canvasMarcher?.fabricGroupObject)) {
//         console.error("FabricObject does not exist for the marcher - realCoordsToCanvasCoords: CanvasUtils.tsx");
//         return null;
//     }
//     let offset = { x: 0, y: 0 };
//     const fabricGroup = canvasMarcher.fabricGroupObject;
//     const dot = (canvasMarcher.fabricGroupObject as fabric.Group)._objects[0] as fabric.Circle;
...
// // Is this needed? Labels still don't update when the drill number changes
