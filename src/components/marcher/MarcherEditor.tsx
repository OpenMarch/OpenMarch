            ...
            {selectedMarchers.length > 0 && (
                <div>
                    {selectedMarchers.length > 1 ? (
                        ...
                        <>
                            <h3 className="bg-green text-xl border-y-gray-500 bg-gray-700 mt-0 border-0 border-y-2 border-solid py-2 pl-4">
                        ...
                        <>
                            <h3 className="text-xl bg-yellow border-y-gray-500 bg-gray-700 mt-0 border-0 border-y-2 border-solid py-2 pl-4">
                                ...
                                {!rCoords ? (
                                    ...
                                    >
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input
                                                className="text-inherit w-12 border-none bg-transparent"
                                                disabled={true}
                                                type="number"
                                            ...
                                            />
                                            <select
                                                className="text-inherit border-none bg-transparent"
                                                disabled={true}
