        ...
        return (
            <RadixTooltip.Root>
                <RadixTooltip.Trigger
                    ...
                    className={twMerge(
                        clsx(
                            "hover:text-accent outline-hidden duration-150 ease-out focus-visible:-translate-y-4 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
                            rest.className,
                        ),
                    )}
                >
