...
function MarcherEditor() {
    ...
    return selectedMarchers.length > 0 ? (
        <EditorContainer
            headerLeftText={
                selectedMarchers.length > 1 ? "Marchers" : "Marcher"
            }
            headerRightText={
        ...
        >
            {selectedMarchers.length > 1 ? (
                ...
                <div>
                    <div>{selectedMarchers.length} Selected</div>
                    <p>
                        {selectedMarchers
                ...
                <div>
                    <div className="text-lg font-bold mb-2">Coordinates</div>
                    {!rCoords ? (
                        <p>Error loading coordinates</p>
                    ) : (
                        <form ref={coordsFormRef} onSubmit={handleCoordsSubmit}>
