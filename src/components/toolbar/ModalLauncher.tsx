                    ...
                    <>
                        ...
                        >
                            <div className="relative w-auto my-6 mx-auto max-w-3xl h-full">
                                {/*content*/}
                                <div className="max-h-[75vh] border-1 rounded shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                    {/*header*/}
                                    <div className="bg-gray-200 flex items-center px-5 border-0 border-b-2 border-solid border-b-gray-400  rounded-t">
                                        <h3 className="text-3xl font-sans text-gray-900 flex-grow">
                                            {header}
                                        </h3>
                                        <button
                                    ...
                                    {/*body*/}
                                    <div id='modal-body' className={"relative py-2 px-6 overflow-scroll flex-auto " + bodyClassName}>
                                    ...
                                    <div className="flex bg-gray-200 items-center p-3 border-0 border-t-2 border-t-gray-400 border-solid rounded-b">
                                        ...
                                        <button className="btn-secondary rounded-md float-right" onClick={closeModal}>
                                            Close
                                        </button>
                                    </div>
                                </div>
