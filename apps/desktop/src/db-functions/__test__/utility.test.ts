...
describeDbTests("utility", (it) => {
    describe("database interactions", () => {
        ...
        describe("getUtility", () => {
            ...
            it("should return the utility record when it exists", async ({
                db,
            }) => {
        ...
        describe("initializeUtility", () => {
            it("should create a new utility record with default values", async ({
                db,
            }) => {
            ...
            it("should return existing utility record if it already exists", async ({
                db,
            }) => {
        ...
        describe("updateUtility", () => {
            testWithHistory(
                ...
                async ({ db }) => {
                    ...
                    const result = await updateUtility({
                        db,
                        args: updateArgs,
                    });
