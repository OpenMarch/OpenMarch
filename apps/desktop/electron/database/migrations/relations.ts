...
import { beats, measures, pages, marcher_pages, marchers, shape_pages, shapes, shape_page_marchers } from "./schema";
...
export const shape_page_marchersRelations = relations(shape_page_marchers, ({one}) => ({
	marcher: one(marchers, {
