...
const toolbarModeOptions = [
    ...
    { value: "light-designer", label: "Light Designer" },
];

export default function Topbar() {
    const { isFullscreen } = useFullscreenStore();
    const [activeTab, setActiveTab] = useState("alignment");
    const [selectedToolbarMode, setSelectedToolbarMode] = useState("editor");
    ...
    return (
        <>
            ...
            <SegmentedTextSwitch
                ...
                selected={selectedToolbarMode}
                setSelected={setSelectedToolbarMode}
